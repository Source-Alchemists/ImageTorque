...
public class GrayscaleFilter : IProcessor<GrayscaleFilterParameters, IPixelBuffer>
{
    ...
    private static PackedPixelBuffer<Mono> RgbToMono(GrayscaleFilterParameters parameters)
    {
        ...
        _ = Parallel.For(0, targetPixelBuffer.Height, parameters.ParallelOptions, row =>
        {
            ...
            Span<Mono> targetRow = targetPixelBuffer.GetRow(row);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static PackedPixelBuffer<Mono8> Rgb24ToMono8(GrayscaleFilterParameters parameters)
    {
        ...
        _ = Parallel.For(0, targetPixelBuffer.Height, parameters.ParallelOptions, row =>
        {
            ...
            Span<Mono8> targetRow = targetPixelBuffer.GetRow(row);
            for (int column = 0; column < targetPixelBuffer.Width; column++)
            {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static PackedPixelBuffer<Mono16> Rgb48ToMono16(GrayscaleFilterParameters parameters)
    {
        ...
        _ = Parallel.For(0, targetPixelBuffer.Height, parameters.ParallelOptions, row =>
        {
            ...
            Span<Mono16> targetRow = targetPixelBuffer.GetRow(row);
            for (int column = 0; column < targetPixelBuffer.Width; column++)
            {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static PackedPixelBuffer<Mono> RgbFFFToMono(GrayscaleFilterParameters parameters)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static PackedPixelBuffer<Mono8> Rgb888ToMono8(GrayscaleFilterParameters parameters)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static PackedPixelBuffer<Mono16> Rgb161616ToMono16(GrayscaleFilterParameters parameters)
    {
