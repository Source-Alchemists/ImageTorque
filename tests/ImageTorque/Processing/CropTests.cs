...
public class CropTests
{
    ...
    [InlineData("./lena8.bmp", 210, 0, 300, 300, 1, "73dc7b6b55f8dfb361ca2029dd76e49472c56d03de88a402cbc667c803f57ef8")]
    ...
    public void Test_Crop_Mono(string imagePath, int x, int y, int width, int height, int rotationDegree, string expectedHash)
    {
        ...
        // Act
        using PixelBuffer<LS> result = (PixelBuffer<LS>)crop.Execute(new CropParameters
        {
    ...
    [InlineData("./lena24.bmp", 210, 0, 300, 300, 1, "ed4f729debbf9ea29528c2da7b26ce3f54bf7f38ed93ebae4cb9d92bf0897688")]
    ...
    public void Test_Crop_Rgb(string imagePath, int x, int y, int width, int height, int rotationDegree, string expectedHash)
    {
        ...
        // Act
        using PixelBuffer<Rgb> result = (PixelBuffer<Rgb>)crop.Execute(new CropParameters
        {
            Input = convertedPixelBuffer.AsReadOnly(),
            Rectangle = new(x, y, width, height, rotationDegree)
        });
    ...
    [InlineData("./lena24.bmp", 210, 0, 300, 300, 1, "117399604358bebf9351830910f5970193480f46dd015ceacf5a556357782b63")]
    ...
    public void Test_Crop_Rgb_Planar(string imagePath, int x, int y, int width, int height, int rotationDegree, string expectedHash)
    {
        ...
        // Act
        using PixelBuffer<LS> result = (PlanarPixelBuffer<LS>)crop.Execute(new CropParameters
        {
            Input = convertedPixelBuffer.AsReadOnly(),
            Rectangle = new(x, y, width, height, rotationDegree)
        });
    ...
    [InlineData("./lena8.bmp", 210, 0, 300, 300, 1, "252f49a93ab893d47eb7b163f9f4474443d20cace6dae8dde8498eba8e2f6ec8")]
    ...
    public void Test_Crop_Mono8(string imagePath, int x, int y, int width, int height, int rotationDegree, string expectedHash)
    {
        ...
        // Act
        using PixelBuffer<L8> result = (PixelBuffer<L8>)crop.Execute(new CropParameters
        {
            Input = pixelBuffer.AsReadOnly(),
            Rectangle = new(x, y, width, height, rotationDegree)
        });
    ...
    [InlineData("./lena16.png", 210, 0, 300, 300, 1, "de3fb3cc1ed483448f674fd5168cd34d0994e813ee2cb83b875d536188c24b31")]
    ...
    public void Test_Crop_Mono16(string imagePath, int x, int y, int width, int height, int rotationDegree, string expectedHash)
    {
        ...
        // Act
        using PixelBuffer<L16> result = (PixelBuffer<L16>)crop.Execute(new CropParameters
        {
            Input = pixelBuffer.AsReadOnly(),
            Rectangle = new(x, y, width, height, rotationDegree)
        });
    ...
    [InlineData("./lena24.bmp", 210, 0, 300, 300, 1, "6cad10c1c09981e3b6997dd4deee89c52f56a978b274070c0b68b298e01df1bd")]
    ...
    public void Test_Crop_Rgb24_Planar(string imagePath, int x, int y, int width, int height, int rotationDegree, string expectedHash)
    {
        ...
        // Act
        using PixelBuffer<L8> result = (PlanarPixelBuffer<L8>)crop.Execute(new CropParameters
        {
            Input = convertedPixelBuffer.AsReadOnly(),
            Rectangle = new(x, y, width, height, rotationDegree)
        });
    ...
    [InlineData("./lena24.bmp", 210, 0, 300, 300, 1, "30d1a3c225b86301961d0cc29d893ff1b2929196edcd2fd757185fade7d55b33")]
    ...
    public void Test_Crop_Rgb24(string imagePath, int x, int y, int width, int height, int rotationDegree, string expectedHash)
    {
        ...
        // Act
        using PixelBuffer<Rgb24> result = (PixelBuffer<Rgb24>)crop.Execute(new CropParameters
        {
            Input = pixelBuffer.AsReadOnly(),
            Rectangle = new(x, y, width, height, rotationDegree)
        });
    ...
    [InlineData("./lena48.png", 210, 0, 300, 300, 1, "348eab0f0ebecc400b5c632654fe07c0b7aac3a5158c762d23cbf6a4b43bdfbc")]
    ...
    public void Test_Crop_Rgb48(string imagePath, int x, int y, int width, int height, int rotationDegree, string expectedHash)
    {
        ...
        // Act
        using PixelBuffer<Rgb48> result = (PixelBuffer<Rgb48>)crop.Execute(new CropParameters
        {
            Input = pixelBuffer.AsReadOnly(),
            Rectangle = new(x, y, width, height, rotationDegree)
        });
    ...
    [InlineData("./lena48.png", 210, 0, 300, 300, 1, "153eb6ee6be99d37138960d785c10b28d7738a2ea94f6c488591a0d5f0da8efc")]
    ...
    public void Test_Crop_Rgb48_Planar(string imagePath, int x, int y, int width, int height, int rotationDegree, string expectedHash)
    {
        ...
        // Act
        using PixelBuffer<L16> result = (PlanarPixelBuffer<L16>)crop.Execute(new CropParameters
        {
            Input = convertedPixelBuffer.AsReadOnly(),
            Rectangle = new(x, y, width, height, rotationDegree)
        });
